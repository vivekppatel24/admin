...
<div id="content">
	...
	<a href="http://phpdolphin.com/demo/index.php?a=settings&b=avatar" rel="loadpage">Profile Images</a>
	<a href="http://phpdolphin.com/demo/index.php?a=settings&b=notifications" rel="loadpage"><strong>Notifications</strong></a>
	...
	<div class="nine columns">
		<div class="page-container">
			<div class="page-content">
				<div class="page-header"><strong>Notifications Settings</strong></div>
				
<form action="http://phpdolphin.com/demo/index.php?a=settings&b=notifications" method="post">
<div class="page-inner">
	<input type="hidden" name="token_id" value="e3a0c5e07392880c5542d773312d9b98">
	<div class="page-input-container">
		<div class="page-input-title">Likes Notifications</div>
		<div class="page-input-content">
			<select name="notificationl">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Likes</strong></div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Comments Notifications</div>
		<div class="page-input-content">
			<select name="notificationc">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Comments</strong></div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Messages Notifications</div>
		<div class="page-input-content">
			<select name="notifications">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Shared Messages</strong></div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Chat Notifications</div>
		<div class="page-input-content">
			<select name="notificationd">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Chats</strong></div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Friends Notifications</div>
		<div class="page-input-content">
			<select name="notificationf">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Confirmed Friendships</strong></div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Groups Notifications</div>
		<div class="page-input-content">
			<select name="notificationg">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Display alert and notifications for <strong>Groups Invitations</strong></div>
		</div>
	</div>
</div>
...
<div class="page-inner">
	<div class="page-input-container">
		<div class="page-input-title">Notifications Sound</div>
		<div class="page-input-content">
			<select name="sound_new_notification">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Play a sound when a new notification is received</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Chat Sound</div>
		<div class="page-input-content">
			<select name="sound_new_chat">
				<option value="0" >Off</option>
				<option value="1" selected="selected">On</option>
			</select>
			<div class="page-input-sub">Play a sound when a new chat message is received</div>
		</div>
	</div>
</div>
<div class="message-divider"></div>
<div class="page-inner">
	<div class="page-input-container">
		<div class="page-input-title">Emails on Comments</div>
		<div class="page-input-content">
			<select name="email_comment">
				<option value="0" selected="selected">Off</option>
				<option value="1" >On</option>
			</select>
			<div class="page-input-sub">Receive emails when someone comments on your messages</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Emails on Likes</div>
		<div class="page-input-content">
			<select name="email_like">
				<option value="0" selected="selected">Off</option>
				<option value="1" >On</option>
			</select>
			<div class="page-input-sub">Receive emails when someone likes your messages</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Emails on Friendships</div>
		<div class="page-input-content">
			<select name="email_new_friend">
				<option value="0" selected="selected">Off</option>
				<option value="1" >On</option>
			</select>
			<div class="page-input-sub">Receive emails when someone sends or confirms a friend request</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Email Group Invite</div>
		<div class="page-input-content">
			<select name="email_group_invite">
				<option value="0" selected="selected">Off</option>
				<option value="1" >On</option>
			</select>
			<div class="page-input-sub">Receive emails when someone sends you a group invitation</div>
		</div>
	</div>
</div>
<div class="message-divider"></div>
