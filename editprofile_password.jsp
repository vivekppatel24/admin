...
<div id="content">
	...
	<a href="http://phpdolphin.com/demo/index.php?a=settings&b=security" rel="loadpage"><strong>Password</strong></a></div>
			</div>
		</div>
	</div>
	<div class="nine columns">
		<div class="page-container">
			<div class="page-content">
				<div class="page-header"><strong>Password Settings</strong></div>
				
<form action="http://phpdolphin.com/demo/index.php?a=settings&b=security" method="post">
<div class="page-inner">
	<input type="hidden" name="token_id" value="e3a0c5e07392880c5542d773312d9b98">
	<div class="page-input-container">
		<div class="page-input-title">Current Password</div>
		<div class="page-input-content">
			<input type="password" name="current_password">
			<div class="page-input-sub">Enter your current password</div>
		</div>
	</div>
</div>
...
<div class="page-inner">
	<div class="page-input-container">
		<div class="page-input-title">New Password</div>
		<div class="page-input-content">
			<input type="password" name="password">
			<div class="page-input-sub">Enter a new password (at least 6 characters)</div>
		</div>
	</div>
	<div class="page-input-container">
		<div class="page-input-title">Repeat Password</div>
		<div class="page-input-content">
			<input type="password" name="repeat_password">
			<div class="page-input-sub">Repeat your new password</div>
		</div>
	</div>
</div>
<div class="message-divider"></div>
