...
<div id="content">
	...
	<a href="http://phpdolphin.com/demo/index.php?a=settings&b=privacy" rel="loadpage"><strong>Privacy</strong></a>
	...
	<div class="nine columns">
		<div class="page-container">
			<div class="page-content">
				<div class="page-header"><strong>Privacy Settings</strong></div>
				
<form action="http://phpdolphin.com/demo/index.php?a=settings&b=privacy" method="post">
<div class="page-inner">
	<input type="hidden" name="token_id" value="e3a0c5e07392880c5542d773312d9b98">
	<div class="page-input-container">
		<div class="page-input-title">Profile</div>
		<div class="page-input-content">
		<select name="private">
			<option value="0" selected="selected">Public</option>
			<option value="2" >Friends</option>
		</select>
		<div class="page-input-sub">Profile visibility</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Message</div>
		<div class="page-input-content">
		<select name="privacy">
		...
		<div class="page-input-sub">The default way of posting messages</div>
		</div>
	</div>
	
	<div class="page-input-container">
		<div class="page-input-title">Chat Status</div>
		<div class="page-input-content">
		<select name="offline">
			<option value="0" selected="selected">Online (when available)</option>
			<option value="1" >Always Offline</option>
		</select>
		<div class="page-input-sub">The visibility status for the Chat</div>
		</div>
	</div>
</div>
