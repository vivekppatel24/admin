...
<head>
<meta charset="UTF-8" />
<title>About - maulik - phpDolphin</title>
		...
		<div class="message-container">
			<div class="message-content">
				<div class="message-inner">
					...
					<div class="about-row"><div class="about-text">Address</div><div class="about-text"><div>40 vaibhav bunglows part - 3</div><div>ahmedabad, India</div></div></div>
					
					<br>
					<div><strong>Basic Information</strong></div>
					<div class="about-row"><div class="about-text">Gender</div><div class="about-text">Male</div></div>
					<div class="about-row"><div class="about-text">Birth Date</div><div class="about-text">February 02, 2015</div></div>
					<div class="about-row"><div class="about-text">Interests</div><div class="about-text">Men</div></div><br>
					<div><strong>Work and Education</strong></div>
					<div class="about-row"><div class="about-text">Works at</div><div class="about-text">ldce</div></div>
					<br>
